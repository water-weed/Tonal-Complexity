...
#chroma toolbox
clp_mat = loadmat('MATLAB-Chroma-Toolbox_2.0\\MATLAB-Chroma-Toolbox_2.0\\data_CLP\\Systematic_Cadence-C-Major_Meinard_portato.mat')
...
"""#NNLS
clp = numpy.genfromtxt('NNLS\\Bach_BWV-Aria-Measures1-4.csv', delimiter=',')"""
